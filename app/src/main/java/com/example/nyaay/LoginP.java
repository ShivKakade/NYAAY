    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i =new Intent(getApplicationContext(),RegistrationP.class);
                startActivity(i);
            }
        });
        ...
        btnlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(em.equals("")||pass.equals(""))
                    Toast.makeText(LoginP.this,"Please enter all fields",Toast.LENGTH_SHORT).show();
                else{
                                    ...
                                    if(task.isSuccessful())
                                    {
                                        ...
                                        root.addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                if(snapshot.exists()){
                                                    Toast.makeText(getApplicationContext(),"Please login in Advocate section",Toast.LENGTH_SHORT).show();

                                                }else{
                                                    Intent intent =new Intent(getApplicationContext(),MainP.class);
